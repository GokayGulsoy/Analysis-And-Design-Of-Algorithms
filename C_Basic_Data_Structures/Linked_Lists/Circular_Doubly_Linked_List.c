...
// function to add a node at the end of a circular doubly linked list
...
// function to delete any node from a circular doubly linked list
...
// function to delete whole circular doubly linked list
